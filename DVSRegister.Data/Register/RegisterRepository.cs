...
namespace DVSRegister.Data
{
    public class RegisterRepository : IRegisterRepository
    {
        ...
        public async Task<List<ProviderProfile>> GetProviders(List<int> roles, List<int> schemes,string searchText = "")
        {
            ...
            providerQuery = providerQuery.Where(p => p.ProviderStatus >= ProviderStatusEnum.Published && p.ProviderStatus != ProviderStatusEnum.RemovedFromRegister&&
            ...
            || EF.Functions.TrigramsSimilarity(p.RegisteredName.ToLower(), searchText.ToLower()) > .3
             ...
             || p.Services.Any(s => EF.Functions.TrigramsSimilarity(s.ServiceName.ToLower(), searchText.ToLower()) > .3)))                    
