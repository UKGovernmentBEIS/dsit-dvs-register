...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240913094939_DropWebSiteAddressColumn")]
    partial class DropWebSiteAddressColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 9, 13, 9, 49, 38, 152, DateTimeKind.Utc).AddTicks(1682)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 9, 13, 9, 49, 38, 152, DateTimeKind.Utc).AddTicks(1687)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 9, 13, 9, 49, 38, 152, DateTimeKind.Utc).AddTicks(1688)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara",
                            CreatedTime = new DateTime(2024, 9, 13, 9, 49, 38, 152, DateTimeKind.Utc).AddTicks(1689)
                        },
                        new
                        {
                            Id = 6,
                            CabName = "NQA",
                            CreatedTime = new DateTime(2024, 9, 13, 9, 49, 38, 152, DateTimeKind.Utc).AddTicks(1690)
                        },
                        new
                        {
                            Id = 7,
                            CabName = "BSI",
                            CreatedTime = new DateTime(2024, 9, 13, 9, 49, 38, 152, DateTimeKind.Utc).AddTicks(1691)
                        });
                });
