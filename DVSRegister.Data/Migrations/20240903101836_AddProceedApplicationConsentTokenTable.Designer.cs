...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240903101836_AddProceedApplicationConsentTokenTable")]
    partial class AddProceedApplicationConsentTokenTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 9, 3, 10, 18, 35, 671, DateTimeKind.Utc).AddTicks(3353)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 9, 3, 10, 18, 35, 671, DateTimeKind.Utc).AddTicks(3357)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 9, 3, 10, 18, 35, 671, DateTimeKind.Utc).AddTicks(3359)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara Initiative",
                            CreatedTime = new DateTime(2024, 9, 3, 10, 18, 35, 671, DateTimeKind.Utc).AddTicks(3360)
                        });
                });
