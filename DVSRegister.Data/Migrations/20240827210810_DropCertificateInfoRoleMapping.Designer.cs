...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240827210810_DropCertificateInfoRoleMapping")]
    partial class DropCertificateInfoRoleMapping
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 8, 27, 21, 8, 10, 76, DateTimeKind.Utc).AddTicks(2170)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 8, 27, 21, 8, 10, 76, DateTimeKind.Utc).AddTicks(2173)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 8, 27, 21, 8, 10, 76, DateTimeKind.Utc).AddTicks(2174)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara Initiative",
                            CreatedTime = new DateTime(2024, 8, 27, 21, 8, 10, 76, DateTimeKind.Utc).AddTicks(2175)
                        });
                });
