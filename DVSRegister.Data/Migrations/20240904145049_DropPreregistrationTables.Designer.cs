...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240904145049_DropPreregistrationTables")]
    partial class DropPreregistrationTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 9, 4, 14, 50, 48, 676, DateTimeKind.Utc).AddTicks(2173)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 9, 4, 14, 50, 48, 676, DateTimeKind.Utc).AddTicks(2180)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 9, 4, 14, 50, 48, 676, DateTimeKind.Utc).AddTicks(2181)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara Initiative",
                            CreatedTime = new DateTime(2024, 9, 4, 14, 50, 48, 676, DateTimeKind.Utc).AddTicks(2182)
                        });
                });
