...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240829205023_UpdateCertificateReviewDateColumns")]
    partial class UpdateCertificateReviewDateColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 8, 29, 20, 50, 21, 799, DateTimeKind.Utc).AddTicks(1424)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 8, 29, 20, 50, 21, 799, DateTimeKind.Utc).AddTicks(1428)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 8, 29, 20, 50, 21, 799, DateTimeKind.Utc).AddTicks(1430)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara Initiative",
                            CreatedTime = new DateTime(2024, 8, 29, 20, 50, 21, 799, DateTimeKind.Utc).AddTicks(1432)
                        });
                });
