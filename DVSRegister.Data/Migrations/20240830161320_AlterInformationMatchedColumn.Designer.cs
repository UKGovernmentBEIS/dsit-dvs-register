...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240830161320_AlterInformationMatchedColumn")]
    partial class AlterInformationMatchedColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 8, 30, 16, 13, 19, 235, DateTimeKind.Utc).AddTicks(3335)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 8, 30, 16, 13, 19, 235, DateTimeKind.Utc).AddTicks(3338)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 8, 30, 16, 13, 19, 235, DateTimeKind.Utc).AddTicks(3339)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara Initiative",
                            CreatedTime = new DateTime(2024, 8, 30, 16, 13, 19, 235, DateTimeKind.Utc).AddTicks(3341)
                        });
                });
