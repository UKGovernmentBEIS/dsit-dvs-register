...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240829111900_AddCertificateReviewField")]
    partial class AddCertificateReviewField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 8, 29, 11, 18, 59, 112, DateTimeKind.Utc).AddTicks(1775)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 8, 29, 11, 18, 59, 112, DateTimeKind.Utc).AddTicks(1778)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 8, 29, 11, 18, 59, 112, DateTimeKind.Utc).AddTicks(1780)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara Initiative",
                            CreatedTime = new DateTime(2024, 8, 29, 11, 18, 59, 112, DateTimeKind.Utc).AddTicks(1782)
                        });
                });
