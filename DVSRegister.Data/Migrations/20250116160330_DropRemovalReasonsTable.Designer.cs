...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20250116160330_DropRemovalReasonsTable")]
    partial class DropRemovalReasonsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2025, 1, 16, 16, 3, 29, 320, DateTimeKind.Utc).AddTicks(167)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2025, 1, 16, 16, 3, 29, 320, DateTimeKind.Utc).AddTicks(172)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2025, 1, 16, 16, 3, 29, 320, DateTimeKind.Utc).AddTicks(173)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara",
                            CreatedTime = new DateTime(2025, 1, 16, 16, 3, 29, 320, DateTimeKind.Utc).AddTicks(174)
                        },
                        new
                        {
                            Id = 6,
                            CabName = "NQA",
                            CreatedTime = new DateTime(2025, 1, 16, 16, 3, 29, 320, DateTimeKind.Utc).AddTicks(175)
                        },
                        new
                        {
                            Id = 7,
                            CabName = "BSI",
                            CreatedTime = new DateTime(2025, 1, 16, 16, 3, 29, 320, DateTimeKind.Utc).AddTicks(176)
                        });
                });
