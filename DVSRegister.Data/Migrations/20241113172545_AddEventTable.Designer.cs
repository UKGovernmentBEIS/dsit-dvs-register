...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20241113172545_AddEventTable")]
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 11, 13, 17, 25, 45, 9, DateTimeKind.Utc).AddTicks(9262)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 11, 13, 17, 25, 45, 9, DateTimeKind.Utc).AddTicks(9266)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 11, 13, 17, 25, 45, 9, DateTimeKind.Utc).AddTicks(9267)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara",
                            CreatedTime = new DateTime(2024, 11, 13, 17, 25, 45, 9, DateTimeKind.Utc).AddTicks(9268)
                        },
                        new
                        {
                            Id = 6,
                            CabName = "NQA",
                            CreatedTime = new DateTime(2024, 11, 13, 17, 25, 45, 9, DateTimeKind.Utc).AddTicks(9269)
                        },
                        new
                        {
                            Id = 7,
                            CabName = "BSI",
                            CreatedTime = new DateTime(2024, 11, 13, 17, 25, 45, 9, DateTimeKind.Utc).AddTicks(9270)
                        });
                });
