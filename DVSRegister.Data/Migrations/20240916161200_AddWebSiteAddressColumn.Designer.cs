...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240916161200_AddWebSiteAddressColumn")]
    partial class AddWebSiteAddressColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 9, 16, 16, 11, 59, 427, DateTimeKind.Utc).AddTicks(2094)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 9, 16, 16, 11, 59, 427, DateTimeKind.Utc).AddTicks(2099)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 9, 16, 16, 11, 59, 427, DateTimeKind.Utc).AddTicks(2101)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara",
                            CreatedTime = new DateTime(2024, 9, 16, 16, 11, 59, 427, DateTimeKind.Utc).AddTicks(2102)
                        },
                        new
                        {
                            Id = 6,
                            CabName = "NQA",
                            CreatedTime = new DateTime(2024, 9, 16, 16, 11, 59, 427, DateTimeKind.Utc).AddTicks(2103)
                        },
                        new
                        {
                            Id = 7,
                            CabName = "BSI",
                            CreatedTime = new DateTime(2024, 9, 16, 16, 11, 59, 427, DateTimeKind.Utc).AddTicks(2105)
                        });
                });
