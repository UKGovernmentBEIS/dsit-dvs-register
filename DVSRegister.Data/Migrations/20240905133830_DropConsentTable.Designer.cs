...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20240905133830_DropConsentTable")]
    partial class DropConsentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 9, 5, 13, 38, 29, 309, DateTimeKind.Utc).AddTicks(9536)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 9, 5, 13, 38, 29, 309, DateTimeKind.Utc).AddTicks(9538)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 9, 5, 13, 38, 29, 309, DateTimeKind.Utc).AddTicks(9540)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara Initiative",
                            CreatedTime = new DateTime(2024, 9, 5, 13, 38, 29, 309, DateTimeKind.Utc).AddTicks(9541)
                        });
                });
