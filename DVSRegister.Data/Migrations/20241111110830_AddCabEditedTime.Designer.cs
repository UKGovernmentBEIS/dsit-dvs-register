...
namespace DVSRegister.Data.Migrations
{
    ...
    [Migration("20241111110830_AddCabEditedTime")]
    partial class AddCabEditedTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DVSRegister.Data.Entities.Cab", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CabName = "EY",
                            CreatedTime = new DateTime(2024, 11, 11, 11, 8, 28, 459, DateTimeKind.Utc).AddTicks(6976)
                        },
                        new
                        {
                            Id = 2,
                            CabName = "DSIT",
                            CreatedTime = new DateTime(2024, 11, 11, 11, 8, 28, 459, DateTimeKind.Utc).AddTicks(6980)
                        },
                        new
                        {
                            Id = 3,
                            CabName = "ACCS",
                            CreatedTime = new DateTime(2024, 11, 11, 11, 8, 28, 459, DateTimeKind.Utc).AddTicks(6981)
                        },
                        new
                        {
                            Id = 4,
                            CabName = "Kantara",
                            CreatedTime = new DateTime(2024, 11, 11, 11, 8, 28, 459, DateTimeKind.Utc).AddTicks(6983)
                        },
                        new
                        {
                            Id = 6,
                            CabName = "NQA",
                            CreatedTime = new DateTime(2024, 11, 11, 11, 8, 28, 459, DateTimeKind.Utc).AddTicks(6984)
                        },
                        new
                        {
                            Id = 7,
                            CabName = "BSI",
                            CreatedTime = new DateTime(2024, 11, 11, 11, 8, 28, 459, DateTimeKind.Utc).AddTicks(6986)
                        });
                });
