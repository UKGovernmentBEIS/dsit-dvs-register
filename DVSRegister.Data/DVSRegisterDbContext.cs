    ...
    public class DVSRegisterDbContext : DbContext, IDataProtectionKeyContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Role { Id = 5, RoleName = "Component Service Provider (CSP)", Order = 5 });
                ...
                new IdentityProfile { Id =1, IdentityProfileName = "L1A ",IdentityProfileType = IdentityProfileTypeEnum.Low, TrustFrameworkVersionId = 1},
                new IdentityProfile { Id =2, IdentityProfileName = "L1B ", IdentityProfileType = IdentityProfileTypeEnum.Low, TrustFrameworkVersionId = 1 },
                new IdentityProfile { Id =3, IdentityProfileName = "L1C ", IdentityProfileType = IdentityProfileTypeEnum.Low, TrustFrameworkVersionId = 1 },
                new IdentityProfile { Id =4, IdentityProfileName = "L2A ", IdentityProfileType = IdentityProfileTypeEnum.Low, TrustFrameworkVersionId = 1 },
                new IdentityProfile { Id =5, IdentityProfileName = "L2B ", IdentityProfileType = IdentityProfileTypeEnum.Low, TrustFrameworkVersionId = 1 },
                new IdentityProfile { Id =6, IdentityProfileName = "L3A ", IdentityProfileType = IdentityProfileTypeEnum.Low, TrustFrameworkVersionId = 1 },
                new IdentityProfile { Id =7, IdentityProfileName = "M1A ", IdentityProfileType = IdentityProfileTypeEnum.Medium, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =8, IdentityProfileName = "M1B ", IdentityProfileType = IdentityProfileTypeEnum.Medium, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =9, IdentityProfileName = "M1C ", IdentityProfileType = IdentityProfileTypeEnum.Medium, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =10, IdentityProfileName = "M1D ", IdentityProfileType = IdentityProfileTypeEnum.Medium, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =11, IdentityProfileName = "M2A ", IdentityProfileType = IdentityProfileTypeEnum.Medium, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =12, IdentityProfileName = "M2B ", IdentityProfileType = IdentityProfileTypeEnum.Medium, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =13, IdentityProfileName = "M2C ", IdentityProfileType = IdentityProfileTypeEnum.Medium, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =14, IdentityProfileName = "M3A ", IdentityProfileType = IdentityProfileTypeEnum.Medium, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =15, IdentityProfileName = "H1A ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =16, IdentityProfileName = "H1B ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =17, IdentityProfileName = "H1C ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =18, IdentityProfileName = "H2A ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =19, IdentityProfileName = "H2B ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =20, IdentityProfileName = "H2C ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =21, IdentityProfileName = "H2D ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =22, IdentityProfileName = "H2E ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =23, IdentityProfileName = "H3A ", IdentityProfileType = IdentityProfileTypeEnum.High, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =24, IdentityProfileName = "V1A ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =25, IdentityProfileName = "V1B ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =26, IdentityProfileName = "V1C ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =27, IdentityProfileName = "V1D ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =28, IdentityProfileName = "V2A ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =29, IdentityProfileName = "V2B ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =30, IdentityProfileName = "V2C ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =31, IdentityProfileName = "V2D ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 },
                new IdentityProfile { Id =32, IdentityProfileName = "V3A ", IdentityProfileType = IdentityProfileTypeEnum.VeryHigh, TrustFrameworkVersionId = 3 });
            ...
            modelBuilder.Entity<ActionDetails>().HasData(
                ...
                new ActionDetails { Id = 33, ActionDetailsKey = nameof(ActionDetailsEnum.PI_ServicePublish_With_TM), ActionDescription = "Service published", ActionCategoryId = 2 },
                new ActionDetails { Id = 34, ActionDetailsKey = nameof(ActionDetailsEnum.PI_ServiceRePublish_With_TM), ActionDescription = "Service updated", ActionCategoryId = 2 },
