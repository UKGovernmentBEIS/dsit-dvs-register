...
{
    public class CabRemovalRequestEmailSender : EmailSender, ICabRemovalRequestEmailSender
    {
        public CabRemovalRequestEmailSender(GovUkNotifyApi govUkNotifyApi, IOptions<GovUkNotifyConfiguration> config) :
            base(govUkNotifyApi, config)
        {
        }


        public async Task<bool> CabServiceRemovalRequested(string recipientName, string emailAddress,
            string companyName, string serviceName, string reasonForRemoval)
        {
        ...
        public async Task<bool> CabServiceRemovalRequestedToDSIT(string companyName, string serviceName,
        ...
        public async Task<bool> RecordRemovalRequestByCabToDSIT(string companyName, string serviceName,
            string reasonForRemoval)
        {
        ...
        public async Task<bool> RecordRemovalRequestConfirmationToCab(string recipientName, string emailAddress,
            string companyName, string serviceName, string reasonForRemoval)
        {
        ...
        public async Task<bool> RemovalRequestCancelledToCab(string emailAddress, string cabName, string companyName,
            string serviceName)
        {
