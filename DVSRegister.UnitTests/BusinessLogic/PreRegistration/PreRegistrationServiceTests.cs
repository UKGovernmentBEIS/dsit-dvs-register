    ...
    public class PreAssessmentServiceTests
    {
        public class PreRegistrationServiceTest
        {
            ...
            public async Task PreRegistrationService_GetCountries()
            {
                ...
                var service = new PreRegistrationService(mockRepo.Object, mockMapper.Object, null,mockLogger.Object);
            ...
            public async Task PreRegistrationService_SavePreRegistration()
            {
                ...
                var service = new PreRegistrationService(mockRepo.Object, mockMapper.Object, mockEmailSender.Object, mockLogger.Object);
