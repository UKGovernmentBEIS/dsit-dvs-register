...
namespace DVSRegister.BusinessLogic.Services.CAB
{
    public interface ICabService
    {
        ...
        public Task<List<IdentityProfileDto>> GetIdentityProfiles(decimal? tfVersion = null);
        public Task<List<SupplementarySchemeDto>> GetSupplementarySchemes();
        public Task<List<TrustFrameworkVersionDto>> GetActiveTfVersion();
        ...
        public Task<GenericResponse> SaveServiceReApplication(ServiceDto serviceDto, string loggedInUserEmail,
            bool isReupload, InProgressApplicationParameters? inProgressApplicationParameters = null);

        public Task<GenericResponse> SaveServiceAmendments(ServiceDto serviceDto, string existingFileLink,
